...
class MpttAdmin(admin.ModelAdmin):
    ...
    change_list_template = "mpttadmin/change_list.html"
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        root = self._node_tpl.render(template.Context({'nodes':self.Meta.model.tree.root_nodes()}))

        return super(MpttAdmin, self).changelist_view(request, extra_context={
